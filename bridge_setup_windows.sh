...
echo "## Start the bridge with: $(tput setaf 6)cd ${HOME}/KoboldAI-Horde && python bridge.py -vv$(tput setaf 7)"
echo "## Or from windows explorer, navigate to $(tput setaf 6)C:\\Users\\$(whoami) $(tput setaf 7)and run $(tput setaf 6)bridge_start.bat"