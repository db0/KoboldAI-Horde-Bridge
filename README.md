...
```bash
curl https://raw.githubusercontent.com/db0/KoboldAI-Horde-Bridge/master/bridge_setup.sh | sh
```
...
```bash
curl https://raw.githubusercontent.com/db0/KoboldAI-Horde-Bridge/master/bridge_setup.sh | sh -s - "1234567890" "The Chicken Circus" "https://your.remote.url.here"
```
